...
class JsonBuilder {
  private var amount: AmountType = _
  private var baseTransactionA: BaseTransactionAType = _
  private var baseTransactionB: BaseTransactionBType = _
  private var baseTransactionC: BaseTransactionCType = _
  private var monetaryTransactionB: MonetaryTransactionBType = _
  private var partyReference: PartyReferenceType = _
  private var title: String = ""
  private var transferTransaction: TransferTransactionType = _
  private var trxMonitoredAccountData: TrxAccountDataType = _
  private var trxPayeeAccountData: TrxAccountDataType = _
  private var trxPayeePartyData: TrxPartyDataType = _
  private var wirePayee: WirePayeeType = _
